    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-light">SCEILL</h1>
          <h2 className="mt-6 text-2xl font-light">Sign in to your account</h2>
          <p className="mt-2 text-gray-600">Continue with your preferred method</p>
        </div>
